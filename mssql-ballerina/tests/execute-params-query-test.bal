...
//     record {}|error? value = queryMssqlClient("Select * from ComplexTypes where row_id = 1");
...
//     validateResult(executeQueryMssqlClient(sqlQuery), 0);
// }
...
//     validateResult(executeQueryMssqlClient(sqlQuery), 1, 2);
// }
