...
//     Client dbClient1 = checkpanic new (host, integratedSecurity, user, password, poolDB_1, port, options, pool);
//     Client dbClient2 = checkpanic new (host, integratedSecurity, user, password, poolDB_1, port, options, pool);
//     Client dbClient3 = checkpanic new (host, integratedSecurity, user, password, poolDB_1, port, options, pool);
//     Client dbClient4 = checkpanic new (host, integratedSecurity, user, password, poolDB_1, port, options, pool);
//     Client dbClient5 = checkpanic new (host, integratedSecurity, user, password, poolDB_1, port, options, pool);
...
//     Client dbClient1 = checkpanic new (host, integratedSecurity, user, password, poolDB_1, port,
//         {loginTimeout: 2, socketTimeout: 10}, pool);
//     Client dbClient2 = checkpanic new (host, integratedSecurity, user, password, poolDB_1, port,
//         {socketTimeout: 10, loginTimeout: 2}, pool);
//     Client dbClient3 = checkpanic new (host, integratedSecurity, user, password, poolDB_1, port,
//         {loginTimeout: 2, socketTimeout: 10}, pool);
//     Client dbClient4 = checkpanic new (host, integratedSecurity, user, password, poolDB_1, port,
//         {loginTimeout: 1}, pool);
//     Client dbClient5 = checkpanic new (host, integratedSecurity, user, password, poolDB_1, port,
//         {loginTimeout: 1}, pool);
//     Client dbClient6 = checkpanic new (host, integratedSecurity, user, password, poolDB_1, port,
//         {loginTimeout: 1}, pool);
...
//     Client dbClient2 = checkpanic new (host, integratedSecurity, user, password, poolDB_1, port, options, pool);
//     Client dbClient3 = checkpanic new (host, integratedSecurity, user, password, poolDB_1, port, options, pool);
//     Client dbClient4 = checkpanic new (host, integratedSecurity, user, password, poolDB_2, port, options, pool);
//     Client dbClient5 = checkpanic new (host, integratedSecurity, user, password, poolDB_2, port, options, pool);
//     Client dbClient6 = checkpanic new (host, integratedSecurity, user, password, poolDB_2, port, options, pool);
...
// returns error? {
//     Client dbClient = check new (host, integratedSecurity, user, password, database, port, options, pool);
//     runtime:sleep(1);
...
//     sql:ConnectionPool pool = {maxOpenConnections: 2};
//     Client dbClient = checkpanic new (host, integratedSecurity, user, password, poolDB_1, port, options, pool);
...
//     Client dbClient = checkpanic new (host, integratedSecurity, user, password, poolDB_1, port, options);
...
//     Client dbClient = check new (host, integratedSecurity, user, password, database, port, options, {maxOpenConnections: 1});
...
//     Client dbClient = check new (host, integratedSecurity, user, password, database, port, options);
...
//     Client dbClient = checkpanic new (host, integratedSecurity, user, password, database, port, options);
//     (int|error)[] returnArray = [];
//     var dt1 = dbClient->query("select count(*) as val from Customers where registrationID = 1", Result);
//     var dt2 = dbClient->query("select count(*) as val from Customers where registrationID = 2", Result);
...
//     Client dbClient1 = checkpanic new (host, integratedSecurity, user, password, database, port, options);
//     Client dbClient2 = checkpanic new (host, integratedSecurity, user, password, database, port, options);
//     Client dbClient3 = checkpanic new (host, integratedSecurity, user, password, database, port, options);
//     Client dbClient4 = checkpanic new (host, integratedSecurity, user, password, database, port, options);
//     Client dbClient5 = checkpanic new (host, integratedSecurity, user, password, database, port, options);

//     stream<record{}, error>[] resultArray = [];

//     resultArray[0] = dbClient1->query("select val = count(*) from Customers where registrationID = 1", Result);
//     resultArray[1] = dbClient1->query("select val = count(*)  from Customers where registrationID = 2", Result);

//     resultArray[2] = dbClient2->query("select val = count(*)  from Customers where registrationID = 1", Result);
//     resultArray[3] = dbClient2->query("select val = count(*)  from Customers where registrationID = 1", Result);

//     resultArray[4] = dbClient3->query("select val = count(*)  from Customers where registrationID = 2", Result);
//     resultArray[5] = dbClient3->query("select val = count(*)  from Customers where registrationID = 2", Result);

//     resultArray[6] = dbClient4->query("select val = count(*)  from Customers where registrationID = 1", Result);
//     resultArray[7] = dbClient4->query("select val = count(*)  from Customers where registrationID = 1", Result);

//     resultArray[8] = dbClient5->query("select val = count(*)  from Customers where registrationID = 1", Result);
//     resultArray[9] = dbClient5->query("select val = count(*)  from Customers where registrationID = 1", Result);

//     resultArray[10] = dbClient5->query("select val = count(*)  from Customers where registrationID = 1", Result);
